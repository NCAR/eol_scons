...
# such as 2.0-14, because that indicates there is an upstream
# tarball *-2.0.orig.tar.gz.
# So when git describe returns v2.0-14-g..., that gets converted
# to a debian version 2.0.14.
