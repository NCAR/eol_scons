...
def generate(env):
    ...
    if env['PLATFORM'] == "darwin":
      env.PrependENVPath('PKG_CONFIG_PATH', env['MACOS_PREFIX'] + '/opt/qt/libexec/lib/pkgconfig')
...
def enable_module_linux(env, module, debug=False):
    ...
    if env['QT6DIR'] == USE_PKG_CONFIG:
        ...
        modpackage = qualify_module_name(module, 'Qt6')
        ...
        if env['PLATFORM'] in ['msys', 'cygwin']:
        ...
        env.Append(LIBS=[qualify_module_name(module, 'Qt6')])
