...
def generate(env):
    ...
    if env['PLATFORM'] == 'darwin':
      ...
      qtPcPath = env['MACOS_PREFIX'] + '/opt/qt/libexec/lib/pkgconfig'
      ...
      if env.get('QT_VERSION') == 6:
        env.AppendUnique(CPPPATH=env['MACOS_PREFIX']+'/opt/qwt/lib/qwt.framework/Headers')
      if env.get('QT_VERSION') == 5:
        env.AppendUnique(CPPPATH=env['MACOS_PREFIX']+'/opt/qwt-qt5/lib/qwt.framework/Headers')
